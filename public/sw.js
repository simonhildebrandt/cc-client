...
},{"./chunk.js":307}],309:[function(require,module,exports){
'use strict';
...
},{"querystringify":309,"requires-port":311}],313:[function(require,module,exports){
/**
...
},{"./lib/bytesToUuid":313,"./lib/rng":314}],316:[function(require,module,exports){
"use strict";
...
function _uploadFile() {
  ...
  regeneratorRuntime.mark(function _callee(record) {
    var fileId, file, extra, name, lastModified, type, size, fileDetails, _ref2, status, json, uploadURL, key;

    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            fileId = record.fileId, file = record.file, extra = record.extra;
            name = file.name, lastModified = file.lastModified, type = file.type, size = file.size;
            fileDetails = {
              name: name,
          ...
          case 17:
            uploadURL = json.uploadURL, key = json.key;
            _context.next = 20;
            return sendFile({
              uploadURL: uploadURL,
              file: file
          ...
          case 22:
            _context.next = 24;
            return (0, _uploadState.saveUploadedFile)(file, key, extra);
  ...
  return fetch(uploadURL, options).then(function (response) {
    if (!response.ok) {
      response.text().then(function (body) {
        return console.log('upload error!', body);
      });
...
var signUpload = function signUpload(file) {
  var url = new _urlParse.default(signingURL, true);
  url.set('query', file);
...
},{"./uploadState":317,"@babel/polyfill":1,"url-parse":312}],317:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.deleteUploadedFile = exports.loadUploadedFiles = exports.saveUploadedFile = exports.deleteFile = exports.loadFiles = exports.saveFile = void 0;
...
var uploadList = (0, _idb.openDB)(name, version, {
  upgrade: function upgrade(db, oldVersion, newVersion, transaction) {
    ...
    db.createObjectStore("uploaded_files", {
      keyPath: "fileId"
    });
  },
...
var saveUploadedFile = function saveUploadedFile(file, key) {
  var extra = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
  var fileId = (0, _v.default)();
  return uploadList.then(function (db) {
    return db.add('uploaded_files', {
      fileId: fileId,
      key: key,
      extra: extra,
      file: file
...
var loadUploadedFiles = function loadUploadedFiles() {
  return uploadList.then(function (db) {
    return db.getAll('uploaded_files');
  });
};

exports.loadUploadedFiles = loadUploadedFiles;

var deleteUploadedFile = function deleteUploadedFile(fileId) {
  return uploadList.then(function (db) {
    return db.delete('uploaded_files', fileId);
  });
};

exports.deleteUploadedFile = deleteUploadedFile;

},{"idb":308,"uuid/v4":315}]},{},[316]);
